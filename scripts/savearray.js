...
dragQueens = dragQueens.sort(() => Math.random() - 0.5);

window.localStorage.setItem("neeewaaaarray", JSON.stringify(dragQueens));
...
//<button id="start" class="hiddenn">Restart game</button>
